...
// from TTree SUSYLooperHists/SUSYLooperHists
// found on file: /afs/cern.ch/work/a/agapitos/public/CMG/CMSSW_5_3_12_patch3/src/CMGTools/TTHAnalysis/cfg/RPV_1200_500/AtoniousSUSY/SUSYLooperHists/SUSYLooperHists_tree.root
//////////////////////////////////////////////////////////

#ifndef SUSYLooperHists_h
#define SUSYLooperHists_h
...
public :
   ...
   SUSYLooperHists(SampleInfo mySample, float Mstop_ = 0, float MLSP_ = 0);
   virtual ~SUSYLooperHists();
...
#ifdef SUSYLooperHists_cxx


//SUSYLooperHists::SUSYLooperHists(TTree *tree) : fChain(0) 
...
SUSYLooperHists::~SUSYLooperHists()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t SUSYLooperHists::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t SUSYLooperHists::LoadTree(Long64_t entry)
{
...
void SUSYLooperHists::Init(TTree *tree)
{
...
void SUSYLooperHists::Show(Long64_t entry)
{
...
Int_t SUSYLooperHists::Cut(Long64_t entry)
{
...
#endif // #ifdef SUSYLooperHists_cxx
